import { TJikanResponse } from '~/types/animeApi';

export const MOCK_TOP_ANIME_LIST: TJikanResponse = {
  pagination: {
    last_visible_page: 1435,
    has_next_page: true,
    current_page: 1,
  },
  data: [
    ...
    },
    {
      ...
      trailer: {
        ...
        embed_url:
          'https://www.youtube.com/embed/MewJ5bEM-5U?si=CMLY929mJ7It0o_l?enablejsapi=1&wmode=opaque&autoplay=1',
        images: {
    ...
    },
    {
      ...
      title_synonyms: ['Code Geass: Hangyaku no Lelouch 2nd Season', 'Code Geass: Hangyaku no Lelouch Second Season'],
      type: 'TV',
      source: 'Original',
      episodes: 25,
      status: 'Finished Airing',
...
export const MOCK_EMPTY_ANIME_LIST: TJikanResponse = {
  pagination: {
    last_visible_page: 1435,
    has_next_page: true,
    current_page: 1,
...
export const MOCK_ANIME_DETAILS = {
  mal_id: 11061,
  url: 'https://myanimelist.net/anime/11061/Hunter_x_Hunter_2011',
  images: {
    jpg: {
